export const enterpriseFlag = {
  "1": "Fannie Mae",
  "2": "Freddie Mac",
};

export const MSACode = {
  "1": "Metropolitan area",
  "0": "Non-metropolitan area",
};

export const censusTract = {
  "1": ">=0, <10%",
  "2": ">=10, <30%",
  "3": ">=30, <=100%",
  "9": "Missing",
...
export const borrowerIncomeRatio = {
  "1": ">=0,<=50%",
  "2": ">50, <=80%",
  "3": ">80%",
  "9": "Not applicable",
...
export const unitAffordabilityCategory = {
